...
const config: Config = {
  ...
  plugins: [
    ...
    // Re-register Base UI / shadcn data-state variants for Tailwind v3
    // (these are defined via @custom-variant in Tailwind v4 but need addVariant here)
    require('tailwindcss/plugin')(({ addVariant }: { addVariant: (n: string, d: string | string[]) => void }) => {
